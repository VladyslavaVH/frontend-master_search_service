  ...
  .init({
    ...
    resources: {
      en: {
        translation: {
          ...
          OfCourse: 'Ok',
          ViewGeolocationTooltip: 'To correctly display job applications near you, we need your location. Please ensure that location services are enabled on your device and in your browser.',
    ...
    uk: {
        translation: {
          ...
          OfCourse: 'Зрозуміло',
          ViewGeolocationTooltip: 'Для коректного відображення заявок про роботу поблизу вас, потрібне ваше місцезнаходження. Будь ласка, переконайтеся, що служби геолокації на пристрої та в браузері ввімкнені.',
      ...
      cs: {
        translation: {
          ...
          OfCourse: 'Samozřejmě',
          ViewGeolocationTooltip: 'Abychom správně zobrazili žádosti o zaměstnání ve vaší blízkosti, potřebujeme vaši polohu. Ujistěte se, že jsou na vašem zařízení a ve vašem prohlížeči povoleny služby určování polohy.',
